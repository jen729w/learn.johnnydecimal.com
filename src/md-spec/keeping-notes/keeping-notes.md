...
<div class="py-1 mb-4 ml-4 mr-10 text-sm italic bg-gray-200 border border-l-8 border-gray-400 rounded-md shadow-sm">
  <ol class="footnote">
    <li>If you’re in a corporate environment and can’t install software, or don’t want to connect your stuff to ‘the cloud’, there are other excellent options available – see ‘Advanced note taking apps’, below.</li>
  </ol>
</div>
