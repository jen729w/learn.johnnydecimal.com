...
const TOC = () => (
	<nav
		className="border border-gray-400 rounded-md shadow-md tableofcontents sm:shadow-none sm:border-l-0 sm:border-t-0 sm:border-b-0 sm:rounded-none sm:border-r"
		tabIndex="100"
	>
