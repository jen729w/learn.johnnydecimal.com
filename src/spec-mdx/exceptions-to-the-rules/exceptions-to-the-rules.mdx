...
More importantly, `1619` is a _better_ way to represent ‘the 19th week of 2016’ than `14.19`. In this case, my numbers were getting in the way.
...
I’m extending the ‘<Link to="/concepts/managing-email/">use Johnny.Decimal numbers in your email subject</Link>’ concept by putting the full number, including the `yyww` bit, in the subject. Our number has grown, but **that’s okay because it’s still very structured.**

This allows me—or the boss—to find any timesheet instantly. Search in Outlook for `[14.01.1619]` and the _only_ thing that appears is my timesheet for this specific week.
