...
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Tax returns</span>
//     {`                        CATEGORY`}
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Payroll</span>
//     {`                            CATEGORY`}
//     <br />
...
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Bookkeeping</span>
//     {`                        CATEGORY`}
//     <br />
//     <br />
//     <span className="underline">Administration</span>
//     {`                         AREA`}
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Company registration</span>
//     {`               CATEGORY`}
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Contracts</span>
//     {`                          CATEGORY`}
//     <br />
...
//     <br />
//     {`    `}
//     <span className="border-b border-red-900">Staffing</span>
//     {`                           CATEGORY`}
//     <br />
//     <br />
...
//     {`———————————————————————————————————————————————————`}
//     <br />
//     <span className="underline">10-19 Finance</span>
//     {`                          AREA`}
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">11 Tax returns</span>
//     {`                      CATEGORY`}
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">12 Payroll</span>
//     {`                          CATEGORY`}
//     <br />
...
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">13 Bookkeeping</span>
//     {`                      CATEGORY`}
//     <br />
//     <br />
//     <span className="underline">20-29 Administration</span>
//     {`                   AREA`}
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">21 Company registration</span>
//     {`             CATEGORY`}
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">22 Contracts</span>
//     {`                        CATEGORY`}
//     <br />
...
//     <br />
//     {`   `}
//     <span className="border-b border-red-900">23 Staffing</span>
//     {`                         CATEGORY`}
//     <br />
//     <br />
//     <span className="underline">30-39 Marketing</span>
//     {`                        AREA`}
//     <br />
//     {`   ...etc.                             ...etc.`}
//   </>
...
export { FirstReminder, TwoGroupThingsTogether, ThreeDoItAgain }
