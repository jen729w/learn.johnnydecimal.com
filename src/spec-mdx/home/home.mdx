---
slug: "/"
date: "2021-01-01T12:00+10:00"
title: "Home"
summary: "An introduction to the Johnny.Decimal system."
---
...
<div className="mr-6 bg-gray-300 rounded-t-md sm:max-w-sm border-gray-700 border-l border-t border-r">
	<span className="inline-block w-4 h-4 mt-2 ml-2 text-xs bg-red-700 rounded-full"></span>
	<span className="inline-block w-4 h-4 mt-2 ml-1 text-xs bg-yellow-500 rounded-full"></span>
	<span className="inline-block w-4 h-4 mt-2 ml-1 text-xs bg-green-500 rounded-full"></span>
</div>

<div className="p-2 mb-8 mr-6 text-yellow-400 bg-gray-900 shadow-md rounded-b-md font-jdmono sm:max-w-sm">
	<span className="pl-2 font-semibold whitespace-pre-wrap">~ $</span> cjd 12.03
	<br />
	<span className="pl-2 font-semibold whitespace-pre-wrap">
