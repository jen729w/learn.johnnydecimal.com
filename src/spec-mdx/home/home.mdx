...
We also know that <span className="jd-inline">42</span> will not be a finance-related category. This is the power of the system: you know where you absolutely should _not_ bother looking to find your data.
...
<span className="mr-4 text-2xl sm:text-4xl jd-inline border-2 px-2">42.18</span>
<span className="mr-4 text-2xl sm:text-4xl jd-inline border-2 px-2">12.03</span>
...
<div className="ml-4 mr-6 bg-gray-300 rounded-t-md sm:max-w-sm">
...
<div className="p-2 mb-8 ml-4 mr-6 text-orange-400 bg-gray-900 shadow-md rounded-b-md font-jdmono sm:max-w-sm">
