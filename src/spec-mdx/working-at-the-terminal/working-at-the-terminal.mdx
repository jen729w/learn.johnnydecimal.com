...
Easier still, use a simple bash script to change to any directory immediately. Put this in your <JD>.bashrc</JD> (<a href="https://gist.github.com/jen729w/cab3a02bce70dab7a4567d460d5c36e2">plain text version here</a>).
...
And now change to any directory with <JD>`cjd 34.27`</JD>.
