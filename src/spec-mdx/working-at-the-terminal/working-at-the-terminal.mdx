...
Easier still, use a simple bash script to change to any directory immediately. Put this in your <span className="border border-gray-600 bg-gray-200 rounded-sm p-1 font-jdmono">.bashrc</span> (<a href="https://gist.github.com/johnnydecimal/cab3a02bce70dab7a4567d460d5c36e2">plain text version here</a>).
...
And now change to any directory with `cjd 34.27`.
