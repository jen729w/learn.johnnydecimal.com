...
- [Multiple-project systems](/concepts/multiple-projects/)
...
<div>
	<div>
		<span className="border-b-2 border-blue-700">AC.ID notation</span>
	</div>
	<div className="text-gray-900 text-base">
		How I refer to the system in the abstract.
	</div>
	<div className="mt-2">
		<span className="border-b-2 border-blue-700">Multiple projects</span>
	</div>
	<div className="text-gray-900 text-base">
		Expanding the system beyond a simple AC.ID structure.
	</div>
</div>
