...
<div className="emailSubject mr-2 sm:mr-6">
	...
	<strong className="text-blue-600">[72.02]</strong>
</div>
...
- know off the top of your head that `72.02` is the number you need, because you’ve used it a lot, or
