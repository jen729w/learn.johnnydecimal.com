...
<div className="emailSubject mr-2 sm:mr-6">
	...
	<strong className="text-orange-600">[72.02]</strong>
</div>
...
- know off the top of your head that <span className="jd-inline">72.02</span> is the number you need, because you’ve used it a lot, or
...
If the email isn’t already in your <span className="jd-inline">72.02</span> folder, just search for <span className="jd-inline">[72.02]</span>.
