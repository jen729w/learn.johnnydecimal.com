...
Three numbers is not two numbers. I think if I'd gone with <JD>PR.AC.ID</JD>, e.g. <JD>10.12.53</JD>, that would have been a bit much on the brain. The only thing in the JD system with three numbers is a project code.
...
<PROACIDbox>
	...
	<Area>102 Another cool project 😎</Area>
	<BlankRow />
	<Project>
		200-299 ACME Corp&nbsp;&nbsp;&nbsp;
		<span className="text-gray-400 font-light">// my current contract</span>
	</Project>
	<Area>201 Project #1</Area>
	<Area>202 Project #2</Area>
...
<PROACIDbox>
	...
	<Area>141 Then you number your projects like this</Area>
	<ID>&nbsp;141.32.73 And individual items like this</ID>
</PROACIDbox>
...
<PROACIDbox>
	<Project classes="no-underline">101 My first project</Project>
	<Project classes="no-underline">
	...
	<Project classes="no-underline">107 you do whatever you want. :-)</Project>
</PROACIDbox>
...
<PROACIDbox>
	...
	<Area>
		...
		<span className="text-gray-400 font-light">// from above, just in its</span>
	</Area>
	<Area>
		20-29 Marketing{" "}
		<span className="text-gray-400 font-light">
