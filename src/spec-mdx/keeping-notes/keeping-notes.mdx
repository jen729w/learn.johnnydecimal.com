...
<Image
	src={Simplenote__3218ohwowanotemin}
	alt="A screenshot of the Simplenote app with a few sample notes."
/>
...
<Image
	src={Simplenote__search22min}
	alt="A screenshot of the Simplenote app with text in the search box and a filtered list of notes."
/>
