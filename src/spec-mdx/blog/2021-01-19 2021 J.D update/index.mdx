...
> 19th January 2021 | [#meta](/blog/tags/meta/)
...
This is an easy one. What do you want to see? I already have a list of things that people have asked me for via email.
...
Things need to be in the right order, categories need to belong to areas and IDs need to belong to categories. Basic sanity-checking stuff to make sure you're not doing something silly.
...
So, **for example** – I'm still thinking about this – you might type:
...
I see interesting possibilities here. For example, you're at work and you're doing something to do with `72 Data centre cabling`. You have a to-do linked to ID `72.16`. While you're there, wouldn't it make sense to look at the other related tasks and maybe do them at the same time? You're 'in the zone' already.
