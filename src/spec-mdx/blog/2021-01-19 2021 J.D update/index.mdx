...
This post is going out as both an email to my subscriber list and as a post on [the new blog](https://johnnydecimal.com/blog/20210120-2021-jd-update/). Exactly the same words, I'll just copy/paste the markdown that makes the blog post in to an email. (I'm not attaching images as the email will go out as plain text.)
